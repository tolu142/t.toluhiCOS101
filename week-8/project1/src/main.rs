...
fn main() {
    ...
    for _ in 0..people_count {
        ...
        println!("What position do you hold in Office administration, Academics, Law or teaching");
        ...
        if (experience == 1 || experience == 2) && (position.to_lowercase() == "intern" || position.to_lowercase() == "paralegal" || position.to_lowercase() == "placement" || position.to_lowercase() == "none") {
            println!("Congratulations! \nYou are eligible for APS 1-2 level");
            ...
            println!("Congratulations! \nYou are eligible for APS 3-5 level");
            ...
            println!("Congratulations! \nYou are eligible for APS 5-8 level");
            ...
            println!("Congratulations! \nYou are eligible for EL1 8-10 level");
            ...
            println!("Congratulations! \nYou are eligible for EL2 10-13 level");
            ...
            println!("Sorry, but you are not eligible.");
        }
    }
